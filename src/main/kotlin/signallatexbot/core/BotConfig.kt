...
data class BotConfig(
    ...
    private val hybridEncrypt: HybridEncrypt by lazy { publicKeysetHandle.getPrimitive(HybridEncrypt::class.java) }

    fun encryptWithPublicKey(stringToEncrypt: String, contextInfo: ByteArray): ByteArray {
